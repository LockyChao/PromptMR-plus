...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_h5_folder', type=str,
                        default='/common/lidxxlab/cmrchallenge/data/CMR2024_chushu',
                        help='path to save H5 dataset')
    parser.add_argument('--input_matlab_folder', type=str,
                        default='/common/lidxxlab/cmrchallenge/data/CMR2024/ChallengeData/MultiCoil',
    ...
    print('h5 kspace folder: ', save_folder)
    ...
    if args.year!=2025:
        ...
        # file_list = sorted(glob.glob(join(mat_folder, '*/TrainingSet/FullSample/*/*/P*/*.mat')))
        file_list = sorted(glob.glob(join(mat_folder, '*/ValidationSet/UnderSample_TaskS1/C*/*/P*/*.mat')))
    ...
    train_folder = os.path.join(output_sym_folder, 'train') # lisha, task 3-s1
    # val_folder = output_sym_folder.replace(save_folder.split('/')[-1], 'val')
    val_folder = os.path.join(output_sym_folder, 'val') # lisha, task 3-s1
    ...
    aftervalid_folder = os.path.join(output_sym_folder, 'after', 'valid') # lisha, task 3-s1
    aftertest_folder = os.path.join(output_sym_folder, 'after', 'test') # lisha, task 3-s1
